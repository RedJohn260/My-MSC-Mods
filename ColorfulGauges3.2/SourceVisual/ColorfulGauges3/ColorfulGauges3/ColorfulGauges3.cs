                ...
                if (fsmMetersInstalled.Value == false)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            SpeedoGaugeMat.mainTexture = LoadAssets.LoadTexture(this, "textures/diffuse_speedo.png");
                            ClockGaugeMat.mainTexture = LoadAssets.LoadTexture(this, "textures/diffuse_speedo.png");
                            RpmGaugeMat.mainTexture = LoadAssets.LoadTexture(this, "textures/diffuse_rpm.png");
                            ...
                            ClockGaugeMat.SetTexture("_EmissionMap", speedoE);
                            SpeedoGaugeMat.SetTexture("_EmissionMap", speedoE);
                            SmallNeedle.SetTexture("_EmissionMap", smallNeedleE);
                            ExtraGauges.SetTexture("_EmissionMap", extraE);
                            RpmGaugeMat.SetTexture("_EmissionMap", rpmE);
                            Tachometer.SetTexture("_EmissionMap", tachoE);
                            GreenNeedle.SetTexture("_EmissionMap", greenE);
                            Odometer.SetTexture("_EmissionMap", odoE);
                            TachoNeedle.SetTexture("_EmissionMap", tachoNeedleE);
                        }
                        catch (Exception)
                        {
                        ...
                        if (fsmClockBolted.Value == true)
                        {
                            ...
                            GameObject.Find("SATSUMA(557kg, 248)/Dashboard/pivot_dashboard/dashboard(Clone)/pivot_meters/dashboard meters(Clone)/pivot_gauge/clock gauge(Clone)/ClockCar/hour/needle_hour").GetComponent<MeshRenderer>().sharedMaterial = SmallNeedle;
                            GameObject.Find("SATSUMA(557kg, 248)/Dashboard/pivot_dashboard/dashboard(Clone)/pivot_meters/dashboard meters(Clone)/pivot_gauge/clock gauge(Clone)/ClockCar/minute/needle_minute").GetComponent<MeshRenderer>().sharedMaterial = SmallNeedle;
                        ...
                        if (fsmRpmBolted.Value == true)
                        {
                            ...
                            GameObject.Find("SATSUMA(557kg, 248)/Dashboard/pivot_dashboard/dashboard(Clone)/pivot_meters/dashboard meters(Clone)/pivot_gauge/rpm gauge(Clone)/Pivot/needle").GetComponent<MeshRenderer>().sharedMaterial = SmallNeedle;
